...
3. Extra tensor operations: getting absolute, min, max and mean values. Additionally, I learn how to identify index of max value or remove size 1 dimensions from a tensor or use one-hot encoder.
